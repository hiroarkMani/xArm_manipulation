...
また，最低限のトピック通信の方法は学んでおいておくことを推奨します．本資料の序盤部分はxarm-developerのgitに書いてあることをそのまま日本語化して、必要なものだけを載せただけです.もし何か分からないことあれば、M2の荒木に聞いてください.
...
* [3.  パッケージの説明と使用上の注意](#3-package-description--usage-guidance)
    ...
    * [3.5 ***xarm7_moveit_config***](#35-xarm7_moveit_config)  
