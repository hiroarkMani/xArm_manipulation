...
他にも, pythonに慣れてない方は最低限練習しておいてください.プログラミングの練習は[会津大学のサイト](https://onlinejudge.u-aizu.ac.jp/beta/ice/)が無料で模範解答も見れるのでおすすめです.
...
もし、xarm等のパッケージに更新があり、本資料ではエラーが出てしまう場合は、お手数ですが更新をお願いします.github分からないかもしれないですけど、なんとなくこの資料のRawデータ見ればわかるはずですので頑張ってください. 初めてのgithubがこれなので参考にならないかもですけども...また、最初の編集者(荒木)は広く浅くなので、所々解説が雑です. 深い部分まで理解が出来た方はドンドン書き加えて、間違ってたら直してください！
※6/19 解答例をアップロードしました！
|更新日|氏名|配属|mail(任意)|
| ------------- | ------------- |------------- | ------------- |
| 2023/6/19| 荒木 博揚 |2020(15期生)| hiroark.mani@gmail.com |
...
ここは、python入門でよく扱う標準入力ができ、チュートリアルファイルに書いている内容が読めれば余裕なはずです.
...
```
↑　これがヒント！！あとはこの[サイト](https://robo-marc.github.io/moveit_documents/moveit_commander.html)を活用して頑張ってみよう. ※gazeboz上にはboxはスポーンされないので注意.(Rvizには現れる)
...
```bash
import tf #これのコメントアウトがあると思うので外してください.
